...
const generateHTML = (taskData) => {
  ...
  <button class="btn btn-outline-info" name=${taskData.id} onclick="editCard.apply(this, arguments)" >
    <i class="fas fa-edit" name=${taskData.id}></i>
  </button>
  ...
  class="card-img"/>
   ...
   <span class="badge rounded-pill bg-primary">${taskData.type}</span>
  </div>
...
const deleteCard = (event) => {
  ...
  const removeTask = globalTaskData.filter((task) => task !== targetID);
